...
class CombinedMargin:
    ...
    Notes
    -----
    ref_link : https://github.com/deepinsight/insightface
...
class ArcFace(CombinedMargin):
    ...
    Notes
    -----
    ref_paper : https://arxiv.org/abs/1801.07698
    formula : cos(theta + m)
    """
...
class CosineFace(CombinedMargin):
    ...
    Notes
    -----
    ref_paper : https://arxiv.org/abs/1801.09414
    formula : cos(theta) - m
    """
...
class SphereFace(CombinedMargin):
    ...
    Notes
    -----
    ref_paper : https://arxiv.org/abs/1704.08063
    formula : cos(theta * m)
    """
